...
namespace InterfazGrafica.UC
{
    public partial class ClientesUC : UserControl
    {
        ...
        public ClientesUC()
        {
            ...
            // Pedimos al controlador que se comunique con el DAL mediante el método PedirListaClientes
            // Este método se conecta con la clase AccesoDatosDAL con su método ListadoClientesNorthWind
            // Éste último a su vez llama al método de la capa DAL RealizarConsultaClientes
            // Se le pasa la string con la consulta sql y es donde se realiza la conexión a la BD
